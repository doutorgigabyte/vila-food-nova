...
const TrustBadgesSection = () => {
  return (
    <section className="py-12 md:py-16 relative overflow-hidden border-y border-border/30">
      {/* Background */}
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="flex flex-col lg:flex-row items-center justify-between gap-8">
          ...
          >
            <span className="text-sm text-muted-foreground font-medium">Parceiros:</span>
            {partners.map((partner, index) => (
              <motion.div
                ...
                className="flex items-center gap-2 px-4 py-2 rounded-full bg-card/50 border border-border/50 hover:border-primary/30 transition-colors"
              >
          ...
          <motion.div
            ...
            className="flex flex-wrap items-center justify-center lg:justify-end gap-6"
          >
