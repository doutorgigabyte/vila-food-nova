  ...
  return (
    <svg viewBox="150 150 700 100" xmlns="http://www.w3.org/2000/svg" className="w-44 h-8 md:w-56 md:h-10 inline-block ml-2">
      ...
      <g id="pacman">
        ...
        <path d="M 200,200 L 260,140 L 260,260 Z" fill="#1a1a1a">
          <animate 
            attributeName="d" 
            dur="0.3s" 
            repeatCount="indefinite"
            values="M 200,200 L 260,200 L 260,200 Z;
                    M 200,200 L 260,140 L 260,260 Z;
                    M 200,200 L 260,200 L 260,200 Z" 
          />
        </path>
      </g>
