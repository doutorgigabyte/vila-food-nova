...
const Footer = () => {
  ...
  return (
    <footer className="bg-foreground text-background py-8 md:py-16">
      <div className="container mx-auto px-4">
        ...
        <div className="md:hidden">
          ...
          <div className="grid grid-cols-2 gap-4 mb-6 text-sm">
            <div>
              <h4 className="font-semibold mb-2 text-xs uppercase tracking-wider text-background/50">Produto</h4>
            ...
            <div>
              <h4 className="font-semibold mb-2 text-xs uppercase tracking-wider text-background/50">Empresa</h4>
              <ul className="space-y-1.5">
            ...
            <div>
              <h4 className="font-semibold mb-2 text-xs uppercase tracking-wider text-background/50">Suporte</h4>
              <ul className="space-y-1.5">
                {links.support.map((link) => (
                  <li key={link.label}>
                    {'external' in link && link.external ? (
                      <a href={link.href} target="_blank" rel="noopener noreferrer" className="text-background/70 hover:text-background transition-colors">
                        {link.label}
                      </a>
                    ) : (
                      <Link to={link.href} className="text-background/70 hover:text-background transition-colors">
            ...
            <div>
              <h4 className="font-semibold mb-2 text-xs uppercase tracking-wider text-background/50">Legal</h4>
              <ul className="space-y-1.5">
          ...
          <Link to="/conheca" className="block mb-6">
            <div className="p-3 rounded-xl bg-primary/10 border border-primary/20 flex items-center gap-3">
              ...
              <div className="flex-1 min-w-0">
                <p className="font-medium text-sm text-background">Tem um restaurante?</p>
                <p className="text-background/70 text-xs truncate">Comece a vender mais!</p>
              </div>
            </div>
          </Link>
          ...
          <div className="pt-4 border-t border-background/10 flex justify-between items-center">
            ...
            <div className="flex items-center gap-3">
              <a href="https://instagram.com/vilafood" target="_blank" rel="noopener noreferrer" className="text-background/50 hover:text-background transition-colors" aria-label="Instagram">
                <Instagram size={18} />
              </a>
              <a href="https://facebook.com/vilafood" target="_blank" rel="noopener noreferrer" className="text-background/50 hover:text-background transition-colors" aria-label="Facebook">
                <Facebook size={18} />
              </a>
            </div>
          </div>
