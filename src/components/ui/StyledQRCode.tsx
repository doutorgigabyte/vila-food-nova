...
export function StyledQRCode({ 
  ...
  const finalLogoUrl = useThemedLogo 
    ? generateThemedLogoDataUrl(primaryColor)
...
export { isLightColor, generateThemedLogoDataUrl };
