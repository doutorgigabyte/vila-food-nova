-- Recria a função RPC com os campos de pagamento corretos
DROP FUNCTION IF EXISTS public.get_establishment_by_instance(text);
...
AS $$
  SELECT 
    ...
    e.pix_key,
    wi.api_key as evolution_api_key
